...
def convolutional_model(input_shape=(NUM_FRAMES,64, 1),    #input_shape(32,32,3)
    ...
    # used to share all the
    # layers across the inputs
...
def VGG16_convolutional_model(input_shape=(NUM_FRAMES,64, 1),
                              batch_size=BATCH_SIZE * TRIPLET_PER_BATCH , num_frames=NUM_FRAMES):
    inputs = Input(shape=input_shape)

    #block 1
    conv_name = 'conv{}-s'.format(64)
    o = Conv2D(64,
                   kernel_size=3,
                   strides=1,
                   padding='same',
                   kernel_initializer='glorot_uniform',
                   kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b11')(o)
    o = clipped_relu(inputs)
    ...
    o = Conv2D(64,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b12')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(64,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_downsample1')(o)
    o = clipped_relu(o)

    #block 2
    conv_name = 'conv{}-s'.format(128)
    o = Conv2D(128,
               kernel_size=3,
               strides=1,
               padding='same',
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b21')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(128,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b22')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(128,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_downsample_b22')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(256,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b23')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b31')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b32')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b33')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_downsample_b3')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b41')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b42')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_conv_b43')(o)
    o = clipped_relu(o)
    ...
    o = Conv2D(512,
               ...
               kernel_initializer='glorot_uniform',
               kernel_regularizer=regularizers.l2(l=0.00001), name=conv_name)(inputs)
    o = BatchNormalization(name=conv_name + 'block1_downsample_b4')(o)
    o = clipped_relu(o)


    # FC3
    o = Lambda(lambda y: K.reshape(y, (-1, math.ceil(num_frames / 16), 2048)), name='reshape')(o)
    o = Lambda(lambda y: K.mean(y, axis=1), name='average')(o)  # shape = (BATCH_SIZE, 512)
    o = Dense(512, name='affine')(o)  # .shape = (BATCH_SIZE , 512)
    o = Lambda(lambda y: K.l2_normalize(y, axis=1), name='ln')(o)

    model = Model(inputs, o, name="'VGG16'")
